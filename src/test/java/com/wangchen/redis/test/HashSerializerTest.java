...
/**
 * 
    * @ClassName: HashSerializerTest
    * @Description:hash序列化测试
    * @author 王晨
    * @date 2019年8月12日
    *
 */
@ContextConfiguration(locations = "classpath:spring-beans3.xml")
...
public class HashSerializerTest {
	...
	public void Stringtest()
	{
		...
		for (User user : list) {
			redis.opsForHash().put(""+user.getId(), "user", user.toString());
		}
		long stoptime = System.currentTimeMillis();
		System.out.println("HashSerializer序列化十万个对象所用时间"+(stoptime-starttime));
